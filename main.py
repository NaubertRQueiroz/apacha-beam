...
def trata_datas(elemento):
    """
    Recebe um dicionário e cria um camapo(hash) com ANO-MES
...
def filtra_campos_vazios(elemento):
    """
    Remove elementos que termina chaves vazias
    Receber uma tupla ('CE-2015-01', {'chuvas': [85.8], 'dengue': [175.0]})
    Retorna uma tuplas ('CE-2015-01', {'chuvas': [85.8], 'dengue': [175.0]})
    """
...
def descompactar_elementos(elem):
    """
    Receber uma tupla ('CE-2015-01', {'chuvas': [85.8], 'dengue': [175.0]})
    Retornar uma tupla ('CE',2015,1,85.8,175.0)
    """
    chave, dados = elem
...
dengue = (
    ...
    | "De texo pra lista" >> beam.Map(texto_para_lista)
...
chuvas = (
    ...
    | "De texto pra lista (chuvas)" >> beam.Map(texto_para_lista, delimitador=',')
    | "Criando a chave UF-ANO-MES" >> beam.Map(chave_uf_ano_mes_lista)
...
resultado = (
    ...
    #| "Agrupas as pcols" >> beam.GroupByKey()
